...
#    Updated: 2022/09/25 07:26:08 by pharbst          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

!#/bin/bash

read -p "Wanna change the ssh port?" confirm && [[ $confirm == [yY] || $confirm == [yY][eE][sS] ]] || exit 1
...
sudo sed 's/.*Port .*/Port $sshport/' /etc/ssh/sshd_config
